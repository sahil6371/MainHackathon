...
export default function App() {
  ...
  // ── Save complaint to Firestore → go to Step 3 ────────
      ...
      <div className="app">
        ...
        <div className="loc-bar">
          ...
          <div className="loc-text">
            {location
              ? <><strong>{location.ward.name}</strong>, Mumbai</>
            ...
            <div className="addr-wrap">
              <div className="addr-box">
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Jaise: Shivaji Nagar, near petrol pump, Lane 3 ke aage... yeh email aur complaint mein bhi jayega"
                  value={addressInput}
        ...
        <div className="profile-overlay" onClick={() => setShowProfile(false)}>
          <div className="profile-sheet" onClick={e => e.stopPropagation()}>
            ...
            <div className="profile-hdr">
              ...
              <div>
                ...
                <div className="profile-count">
                  {complaints.length} complaint{complaints.length !== 1 ? 's' : ''} reported
                </div>
              </div>
            ...
            {!loadingComplaints && complaints.map(c => (
              <div className="c-card" key={c.id}>
                <div className="c-card-hdr">
                  ...
                  <div className="c-sev" style={{ background: severityBg(c.severity), color: severityColor(c.severity) }}>
                    {c.severity}
                  </div>
                </div>
                ...
                <div
                  className="c-track"
                  onClick={() => window.open(`https://nagrik-ai-eta.vercel.app/complaint/${c.complaintId}`, '_blank')}
                >
            ...
            <button
              ...
              onClick={() => { localStorage.removeItem('nagrik_user'); setUser(null); setShowProfile(false) }}
            >
              🚪 Logout
            </button>
